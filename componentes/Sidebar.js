...
<Link href="/nuevaCategoria">
          ...
          <Link href="/autenticarse">
          <button className="bg-gray-500 hover:bg-gray-400 text-white text-3xl font-bold py-2 px-4 border-b-4 border-gray-700 hover:border-gray-500 rounded ml-2 mt-4 self-center">
            Administrador
          </button>
          </Link>
        )}
